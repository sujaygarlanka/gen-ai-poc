...
def create_pull_request(branch_name, title, description, repo_owner, repo_name):
...
def create_command(prompt, branch_name, commit_message, pr_title, pr_description):
    ...
    try:
        ...
        pr_url = create_pull_request(branch_name, pr_title, pr_description, repo_owner, repo_name)
...
def main():
    ...
    if args.command == 'update':
        ...
        success = create_command(args.prompt, branch_name, commit_message, pr_title, pr_description)
        sys.exit(0 if success else 1)
